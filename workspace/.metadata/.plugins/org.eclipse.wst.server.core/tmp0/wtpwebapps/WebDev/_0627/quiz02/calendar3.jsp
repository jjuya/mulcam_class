...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-35" data-genuitec-path="/WebDev/WebContent/_0627/quiz02/calendar3.jsp">
<form name="myform" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-35" data-genuitec-path="/WebDev/WebContent/_0627/quiz02/calendar3.jsp">
...
<%
	...
	for(int d=1, w=week; d <= end_day; d++, w++) {
		...
		if(cnt % 7 == 0) {
			out.println("<td class='td0'>" + d + "</td>");
		}
		else if(cnt % 7 == 6) {
			out.println("<td class='td6'>" + d + "</td>");
		}
		else {
			out.println("<td>" + d + "</td>");
		}
