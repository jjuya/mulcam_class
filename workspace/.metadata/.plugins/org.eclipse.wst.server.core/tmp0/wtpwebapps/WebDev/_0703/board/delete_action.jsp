...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-85" data-genuitec-path="/WebDev/WebContent/_0703/board/delete_action.jsp">
<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-85" data-genuitec-path="/WebDev/WebContent/_0703/board/delete_action.jsp">
<% if(result) { %>
	alert('글 삭제 성공');
