...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-90" data-genuitec-path="/WebDev/WebContent/_0703/board/update_action.jsp">
<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-90" data-genuitec-path="/WebDev/WebContent/_0703/board/update_action.jsp">
<% if(result) { %>
	alert('글 수정 성공');
