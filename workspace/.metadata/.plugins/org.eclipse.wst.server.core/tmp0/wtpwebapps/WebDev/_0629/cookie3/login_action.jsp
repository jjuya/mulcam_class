...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-77" data-genuitec-path="/WebDev/WebContent/_0629/cookie3/login_action.jsp">
<% if (user_name != null) {
		out.println(user_name + "회원님이 로그인 되었습니다.");
   } else { %>
<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-77" data-genuitec-path="/WebDev/WebContent/_0629/cookie3/login_action.jsp">
