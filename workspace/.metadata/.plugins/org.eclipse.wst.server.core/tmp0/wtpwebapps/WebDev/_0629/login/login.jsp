...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-72" data-genuitec-path="/WebDev/WebContent/_0629/login/login.jsp">

<form action="login_action.jsp" method="post" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-72" data-genuitec-path="/WebDev/WebContent/_0629/login/login.jsp">
<table>
	<caption>로그인</caption>
