...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-53" data-genuitec-path="/WebDev/WebContent/_0628/jsp/forward/forwardTest.jsp">
...
<%
	...
	if(age <= 19) {
%>
	<script data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-53" data-genuitec-path="/WebDev/WebContent/_0628/jsp/forward/forwardTest.jsp">
