...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-45" data-genuitec-path="/WebDev/WebContent/_0628/eeee.jsp">
<% 
	RequestDispatcher dispatcher = 
		request.getRequestDispatcher("calendar4.jsp");
