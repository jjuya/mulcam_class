...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-13" data-genuitec-path="/WebDev/WebContent/_0619/cal/calendar.jsp">
<%-- html 주석 --%>
<% //scriptlet
...
<%= year + " 년 " + month + " 월 " %>
<table data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-13" data-genuitec-path="/WebDev/WebContent/_0619/cal/calendar.jsp">
<tr>
	<td>일</td>
	<td>월</td>
	<td>화</td>
