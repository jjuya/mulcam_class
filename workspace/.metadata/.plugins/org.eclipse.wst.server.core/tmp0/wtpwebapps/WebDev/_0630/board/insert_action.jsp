...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-81" data-genuitec-path="/WebDev/WebContent/_0630/board/insert_action.jsp">
<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-81" data-genuitec-path="/WebDev/WebContent/_0630/board/insert_action.jsp">
<% if(result) { %>
	alert('글 등록 성공');
