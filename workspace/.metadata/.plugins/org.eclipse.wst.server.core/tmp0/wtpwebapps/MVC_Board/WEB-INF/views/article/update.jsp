...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-5" data-genuitec-path="/MVC_Board/WebContent/WEB-INF/views/article/update.jsp">
<form action="updateAction" method="post"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-5" data-genuitec-path="/MVC_Board/WebContent/WEB-INF/views/article/update.jsp">
<div class="container">
<label>게시물 수정</label>
