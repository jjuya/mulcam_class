...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-12" data-genuitec-path="/MVC_Board/WebContent/WEB-INF/views/article/delete.jsp">
<form action="deleteAction" method="post"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-12" data-genuitec-path="/MVC_Board/WebContent/WEB-INF/views/article/delete.jsp">
<div class="container">
<label>게시물 삭제</label>
