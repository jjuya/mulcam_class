...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/MVC_Board/WebContent/WEB-INF/views/article/insert.jsp">
<form action="insertAction" method="post"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/MVC_Board/WebContent/WEB-INF/views/article/insert.jsp">
<div class="container">
<label>게시물 입력</label>
