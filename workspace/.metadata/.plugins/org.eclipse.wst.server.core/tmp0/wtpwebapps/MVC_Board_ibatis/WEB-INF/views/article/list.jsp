...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-4" data-genuitec-path="/MVC_Board_ibatis/WebContent/WEB-INF/views/article/list.jsp">
	
<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-4" data-genuitec-path="/MVC_Board_ibatis/WebContent/WEB-INF/views/article/list.jsp">
	<label>게시물 리스트</label>
